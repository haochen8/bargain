/**
 * This component displays products in the Electronics category.
 *
 * @author Hao Chen
 * @component
 * @returns {JSX.Element} The Electronics page component.
 */
...
/**
 * Handles displaying products in the Electronics category.
 *
 * @returns {JSX.Element} The Electronics page component.
 */
const Electronics = () => {
  ...
  /**
   * Fetch Electronics products from the backend.
   */
  const fetchElectronicsProducts = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/api/product?category=Electronics`
      );
